...
const categories = [
  ...
  {
    id: 5, name: 'Sale', href: '#', imageSrc: 'https://tailwindui.com/img/ecommerce-images/home-page-01-category-03.jpg'
  },
]
export default function Home() {
  return (
    <>
      ...
      <CategoryBlockTwo />
      <ProductList products={products} title="New Launch" subTitle="Offer : 20% off till Sept 10th" />
