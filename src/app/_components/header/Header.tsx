    ...
    return (
        <div className="bg-white">
            ...
            <Dialog open={open} onClose={setOpen} className="relative z-40 lg:hidden">
                <DialogBackdrop
                    transition
                    className="fixed inset-0 bg-black bg-opacity-100 transition-opacity duration-300 ease-linear data-[closed]:opacity-0"
                />
                                ...
                                <div className="flex h-full space-x-8">
                                    {navigation.categories.map((category) => (
                                        <Popover key={category.name} className="flex">
                                            ...
                                            <PopoverPanel
                                                transition
                                                className="absolute inset-x-0 top-full transition data-[closed]:opacity-0 data-[enter]:duration-200 data-[leave]:duration-150 data-[enter]:ease-out data-[leave]:ease-in z-10"
                                            >
